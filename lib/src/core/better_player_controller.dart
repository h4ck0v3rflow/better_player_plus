...
class BetterPlayerController {
  ...
  static const String _percentParameter = 'percent';
      ...
      _postEvent(
        BetterPlayerEvent(
          ...
          parameters: <String, dynamic>{
            _percentParameter: videoPlayerController?.value.initialized ?? false ? 100.0 : 0.0,
          },
        ),
      );
    }
      ...
      case VideoEventType.bufferingUpdate:
        _postEvent(
          BetterPlayerEvent(
            ...
            parameters: <String, dynamic>{_bufferedParameter: event.buffered, _percentParameter: event.percent},
          ),
        );
          ...
          for (final track in tracks) {
            if (track is Map) {
              try {
                ...
                asmsTracks.add(BetterPlayerAsmsTrack(track['id']?.toString(), width, height, bitrate, 0, '', ''));
              } catch (e) {
                print("BetterPlayerController: Error parsing track: $e");
              }
            }
          }
          // Tracks parsed successfully
