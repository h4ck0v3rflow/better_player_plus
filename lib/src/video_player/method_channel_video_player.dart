...
class MethodChannelVideoPlayer extends VideoPlayerPlatform {
  ...
  @override
  Future<void> dispose(int? textureId) => _channel.invokeMethod<void>(
    'dispose',
  ...
  Future<int?> create({
    ...
    if (bufferingConfiguration == null) {
      ...
      final responseLinkedHashMap = await _channel
          .invokeMethod<Map<Object?, dynamic>?>('create', <String, dynamic>{
  ...
  Future<void> setLooping(int? textureId, bool looping) =>
      _channel.invokeMethod<void>('setLooping', <String, dynamic>{
        'textureId': textureId,
        'looping': looping,
      });

  @override
  Future<void> play(int? textureId) => _channel.invokeMethod<void>(
    'play',
    <String, dynamic>{'textureId': textureId},
  );

  @override
  Future<void> pause(int? textureId) => _channel.invokeMethod<void>(
    'pause',
    <String, dynamic>{'textureId': textureId},
  );
  ...
  Future<void> setSpeed(int? textureId, double speed) =>
      _channel.invokeMethod<void>('setSpeed', <String, dynamic>{
        'textureId': textureId,
        'speed': speed,
      });
  ...
  Future<void> setTrackParameters(
    ...
    int? height,
    int? bitrate,
  ) => _channel.invokeMethod<void>('setTrackParameters', <String, dynamic>{
    'textureId': textureId,
    'width': width,
    'height': height,
    'bitrate': bitrate,
  ...
  Future<void> seekTo(int? textureId, Duration? position) =>
      _channel.invokeMethod<void>('seekTo', <String, dynamic>{
        'textureId': textureId,
  ...
  Future<void> disablePictureInPicture(int? textureId) =>
      _channel.invokeMethod<bool>('disablePictureInPicture', <String, dynamic>{
        'textureId': textureId,
      });

  @override
  Future<void> setAudioTrack(int? textureId, String? name, int? index) =>
      _channel.invokeMethod<void>('setAudioTrack', <String, dynamic>{
        'textureId': textureId,
        'name': name,
        'index': index,
      });
  ...
  Future<void> setMixWithOthers(int? textureId, bool mixWithOthers) =>
      _channel.invokeMethod<void>('setMixWithOthers', <String, dynamic>{
        'textureId': textureId,
  ...
  Future<void> clearCache() =>
      _channel.invokeMethod<void>('clearCache', <String, dynamic>{});
  ...
  Future<void> stopPreCache(String url, String? cacheKey) =>
      _channel.invokeMethod<void>('stopPreCache', <String, dynamic>{
        'url': url,
        'cacheKey': cacheKey,
      });
  ...
  Stream<VideoEvent> videoEventsFor(
    ...
    switch (eventType) {
      ...
      case 'tracksChanged':
        print(
          "MethodChannel: Received tracksChanged event with ${map['tracks']?.length} tracks",
        );
        return VideoEvent(
  ...
  EventChannel _eventChannelFor(int? textureId) =>
      EventChannel('better_player_channel/videoEvents$textureId');
